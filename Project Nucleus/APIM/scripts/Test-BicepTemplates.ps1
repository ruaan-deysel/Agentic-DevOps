...
# Run the tests
Write-Host "Running APIM Bicep Tests" -ForegroundColor Cyan
...
$requiredParams = @('apimServiceName', 'environment', 'sku')
$test2Result = Test-ParameterFileRequiredParams -ParameterFilePath ".\config\ms.apim\parameters.dev.bicepparam" -TestName "DevParametersRequiredParams" -RequiredParameters $requiredParams
$testResults += [PSCustomObject]@{
...
$test3Result = Test-ParameterFileRequiredParams -ParameterFilePath ".\config\ms.apim\parameters.test.bicepparam" -TestName "TestParametersRequiredParams" -RequiredParameters $requiredParams
$testResults += [PSCustomObject]@{
...
$test4Result = Test-ParameterFileRequiredParams -ParameterFilePath ".\config\ms.apim\parameters.prod.bicepparam" -TestName "ProdParametersRequiredParams" -RequiredParameters $requiredParams
$testResults += [PSCustomObject]@{
...
$test5Result = Test-ParameterFileAgainstBicep -BicepFilePath ".\main.bicep" -ParameterFilePath ".\config\ms.apim\parameters.dev.bicepparam" -TestName "DevParametersValidation"
$testResults += [PSCustomObject]@{
...
$test6Result = Test-ParameterFileAgainstBicep -BicepFilePath ".\main.bicep" -ParameterFilePath ".\config\ms.apim\parameters.test.bicepparam" -TestName "TestParametersValidation"
$testResults += [PSCustomObject]@{
...
$test7Result = Test-ParameterFileAgainstBicep -BicepFilePath ".\main.bicep" -ParameterFilePath ".\config\ms.apim\parameters.prod.bicepparam" -TestName "ProdParametersValidation"
$testResults += [PSCustomObject]@{
